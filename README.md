...
| 핵심 로직 유닛 테스트 | 뮤테이션 코어, 병합 규칙, 롤백, 가상 스크롤 계산, 필터 등 72개 테스트 |
...
| 검색 디바운싱, 다중 필터 | 180ms 디바운스 + useDeferredValue. 우선순위 토글, 태그와 담당자 다중 선택 드롭다운(옵션은 데이터에서 파생) |
